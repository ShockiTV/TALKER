...
local game_files = talker_game_files or require('core.tests.mocks.mock_game_queries') -- todo improve
...
local is_test_env, mock_game_adapter = pcall(require, 'core.tests.mocks.mock_game_adapter')
