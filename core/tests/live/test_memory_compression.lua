...
local mock_characters = require('core.tests.mocks.mock_characters')
...
function TestGetCurrentMemories()
    ...
    file_io.override("core/tests/live/output/" .. current_test ..'.json', json.encode(output))
end
...
function Test_MemoryCompression()
    ...
    for i, event in ipairs(events) do
        ...
        AI_request.compress_memories(mock_characters[2].game_id, function(speaker_id)
            ...
            file_io.override("core/tests/live/output/" .. current_test .. '/' .. i ..'.json', json.encode(simpler_memories) .. '\n')
        end)
    end
